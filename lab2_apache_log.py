...
#print 'Unique hosts: %s' % uniqueHostCount
...
avgDailyReqPerHost = dayAndHostTuple.groupByKey().mapValues(lambda y: len(y)/len(set(y))).sortByKey().cache()
...
#print 'debug: %s' % badEndpointsSum.take(10)
